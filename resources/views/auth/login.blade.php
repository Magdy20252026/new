...
<head>
    ...
    <title>تسجيل الدخول - {{ $siteSettings['site_name'] ?? 'الأكاديمية' }}</title>
            ...
            <div class="row justify-content-center align-items-center min-vh-100 py-4">
                <div class="col-12 col-md-9 col-lg-7 col-xl-5">
                        ...
                        <div class="swim-login-inner">
                            <div class="brand-area text-center">
                                ...
                                <h1 class="brand-title">
                                    {{ $siteSettings['site_name'] ?? 'اسم الأكاديمية' }}
                                </h1>
                            </div>
                            ...
                            <form action="{{ route('login.submit') }}" method="POST">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn swim-login-btn">
                    ...
                    <div class="copyright-text text-center">
                        © {{ date('Y') }} {{ $siteSettings['site_name'] ?? 'الأكاديمية' }}
                    </div>
                </div>
            </div>
        </div>
