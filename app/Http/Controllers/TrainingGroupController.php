...
class TrainingGroupController extends Controller
{
    ...
    protected function validatedPayload(Request $request, Branch $branch): array
    {
        $validator = Validator::make($request->all(), [
            ...
            'available_training_days' => ['required', 'integer', 'min:1'],
            ...
            'available_training_days.required' => 'عدد مرات التمرين المتاحة مطلوب',
            'available_training_days.integer' => 'عدد مرات التمرين المتاحة غير صحيح',
            'available_training_days.min' => 'عدد مرات التمرين المتاحة يجب أن يكون مرة واحدة على الأقل',
